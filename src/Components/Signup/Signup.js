...
const Signup = () => {
    ...
    return (
        <div data-aos="fade-up" className='rounded-lg shadow-sm flex justify-center items-center lg:w-1/2 my-14 mx-auto border border-gray-200'>
            <div className="card p-8 bg-base-100 ">
                ...
                <form onSubmit={handleSubmit(handlesignup)}>
                    ...
                    <input type="submit" className='btn bg-[#ED7D2B] border-none text-white mt-8 w-full rounded-sm' value={'Register'} />
